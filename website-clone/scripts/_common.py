"""website-clone（主控）脚本共用的小工具（仅标准库）。

与 website-clone-visual / website-clone-functional 里的同名文件故意保持独立：安装单位是目录，不做跨目录引用。
"""
...
def classify_url(url: str) -> str:
    """只看 URL 的页面类型粗分类：landing / list / detail / auth / checkout / search / account / legal / admin / content。"""
